...
type DelegationMemoryConfig struct {
	Metadata DelegationMemoryMetadataConfig `json:"metadata,omitempty"`
}

type DelegationMemoryMetadataConfig struct {
	ProjectKey string   `json:"project_key,omitempty" env:"PICOCLAW_AGENTS_DEFAULTS_DELEGATION_MEMORY_METADATA_PROJECT_KEY"`
	Labels     []string `json:"labels,omitempty"      env:"PICOCLAW_AGENTS_DEFAULTS_DELEGATION_MEMORY_METADATA_LABELS"`
	Source     string   `json:"source,omitempty"      env:"PICOCLAW_AGENTS_DEFAULTS_DELEGATION_MEMORY_METADATA_SOURCE"`
}
...
type AgentDefaults struct {
	...
	AsyncDelegation           AsyncDelegationConfig  `json:"async_delegation,omitempty"     envPrefix:"PICOCLAW_AGENTS_DEFAULTS_ASYNC_DELEGATION_"`
	DelegationMemory          DelegationMemoryConfig `json:"delegation_memory,omitempty"   envPrefix:"PICOCLAW_AGENTS_DEFAULTS_DELEGATION_MEMORY_"`
...
type ToolsConfig struct {
	...
	DelegationInbox  ToolConfig         `json:"delegation_inbox"     yaml:"-"              envPrefix:"PICOCLAW_TOOLS_DELEGATION_INBOX_"`
	DelegationStatus ToolConfig         `json:"delegation_status"    yaml:"-"              envPrefix:"PICOCLAW_TOOLS_DELEGATION_STATUS_"`
	...
	Meeting          ToolConfig         `json:"start_agent_meeting"  yaml:"-"              envPrefix:"PICOCLAW_TOOLS_START_AGENT_MEETING_"`
...
func (t *ToolsConfig) IsToolEnabled(name string) bool {
	...
	case "delegation_inbox":
		return t.DelegationInbox.Enabled
	case "delegation_status":
		return t.DelegationStatus.Enabled
	case "edit_file":
	...
	case "start_agent_meeting":
		return t.Meeting.Enabled
	case "read_file":
