...
- [Agent Delegation And Meetings](agent-delegation-meetings.md): durable target-agent delegation, chaired meetings, GitHub artifacts, memory fallback, and visibility boundaries.
- [Agent Organization Live Verification](agent-organization-live-verification.md): staged operator checks for the launcher organization page, activity summaries, drill-down APIs, and read-only guarantees.
